...
|70 |[Check if Word Equals Summation of Two Words](src/string_problems/check_if_word_equals_summation_of_two_words.py)|[string](src/string_problems)|Easy|[Leetcode](https://leetcode.com/problems/check-if-word-equals-summation-of-two-words/description/)|
|71 |[Maximum Value after Insertion](src/greedy_problems/maximum_value_after_insertion.py)|[greedy](src/greedy_problems)|Medium|[Leetcode](https://leetcode.com/problems/maximum-value-after-insertion/description/)|
|72 |[Determine Whether Matrix Can Be Obtained By Rotation](src/array_problems/determine_whether_matrix_can_be_obtained_by_rotation.py)|[array](src/array_problems)|Easy|[Leetcode](https://leetcode.com/problems/determine-whether-matrix-can-be-obtained-by-rotation/description/)|
|73 |[Reduction Operations to Make the Array Elements Equal](src/greedy_problems/reduction_operations_to_make_the_array_elements_equal.py)|[greedy](src/greedy_problems)|Medium|[Leetcode](https://leetcode.com/problems/reduction-operations-to-make-the-array-elements-equal/description/)|
|74 |[Redistribute Characters to Make All Strings Equal](src/string_problems/redistribute_characters_to_make_all_strings_equal.py)|[string](src/string_problems)|Easy|[Leetcode](https://leetcode.com/problems/redistribute-characters-to-make-all-strings-equal/description/)|
|75 |[Maximum Number of Removable Characters](src/array_problems/maximum_number_of_removable_characters.py)|[array](src/array_problems)|Medium|[Leetcode](https://leetcode.com/problems/maximum-number-of-removable-characters/description/)|
|76 |[Merge Triplets to Form Target Triplet](src/array_problems/merge_triplets_to_form_target_triplet.py)|[array](src/array_problems)|Medium|[Leetcode](https://leetcode.com/problems/merge-triplets-to-form-target-triplet/description/)|
|77 |[Maximum Product Difference Between Two Pairs](src/math_problems/maximum_product_difference_between_two_pairs.py)|[math](src/math_problems)|Easy|[Leetcode](https://leetcode.com/problems/maximum-product-difference-between-two-pairs/description/)|
|78 |[Cyclically Rotating a Grid](src/array_problems/cyclically_rotating_a_grid.py)|[array](src/array_problems)|Medium|[Leetcode](https://leetcode.com/problems/cyclically-rotating-a-grid/description/)|
