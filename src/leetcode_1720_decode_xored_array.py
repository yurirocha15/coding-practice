...
class Solution:
    def decode(self, encoded: List[int], first: int) -> List[int]:
        # the inverse of the XOR opperation is the XOR opperation
        # the walrus opperator ':=' stores the value in the list while also
        # assigning it to the left side variable
