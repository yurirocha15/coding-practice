...
# This is represented by a 2D string array knowledge where each knowledge[i] = [keyi,
# valuei] indicates that key keyi has a value of valuei.
...
if __name__ == "__main__":
    ...
    pytest.main([os.path.join("tests", "test_1807.py")])
