...
if __name__ == "__main__":
    ...
    assert solution.can_mouse_win(grid=["M.C...F"], catJump=1, mouseJump=4)
    assert not solution.can_mouse_win(grid=["M.C...F"], catJump=1, mouseJump=3)
    assert not solution.can_mouse_win(
