...
#
# Construct a boolean array answer such that answer.length == queries.
# length and answer[i] is true if you can eat a candy of type favoriteTypei on day favoriteDayi without eating more than dailyCapi candies on any day,
...
#    If you eat 4 candies every day,
# you will eat 4 candies (type 0) on day 0 and 4 candies (type 0 and type 1) on day 1.
#    On day 2,you can only eat 4 candies (type 1 and type 2),
# so you cannot eat a candy of type 4 on day 2.
...
if __name__ == "__main__":
    ...
    pytest.main([os.path.join("tests", "test_1744.py")])
