...
it takes to complete all jobs assigned to them.
Your goal is to devise an optimal assignment such that
...
if __name__ == "__main__":
    solution = Solution()
    assert solution.minimum_time_required(jobs=[3, 2, 3], k=3) == 3
    assert solution.minimum_time_required(jobs=[1, 2, 4, 7, 8], k=2) == 11
