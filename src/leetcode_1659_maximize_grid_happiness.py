...
# |......|
#
# up_row = [ooiieo], j = 3, up cell index = 3, left cell index = 2
#
#
#
...
class Solution:
    def getMaxGridHappiness(
        ...
        @memoization
        def dp(int_c, ext_c, i, j, row_tup):
        ...
        # start dp
        return dp(introvertsCount, extrovertsCount, 0, 0, tuple(self.up_row))
...
if __name__ == "__main__":
    ...
    pytest.main([os.path.join("tests", "test_1659.py")])
