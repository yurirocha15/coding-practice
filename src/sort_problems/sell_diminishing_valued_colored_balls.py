...
if __name__ == "__main__":
    solution = Solution()
    assert solution.max_profit([2, 5], 4) == 14
    assert solution.max_profit([3, 5], 6) == 19
    assert solution.max_profit([2, 8, 4, 10, 6], 20) == 110
    assert solution.max_profit([1000000000], 1000000000) == 21
